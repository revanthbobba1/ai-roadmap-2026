...
async def call_claude(
    ...
    try:
        ...
        # messages.create(); extra_body is the documented path. OpenAI's SDK
        # still takes temperature directly — see call_openai below. Another
        # provider asymmetry to keep track of.
